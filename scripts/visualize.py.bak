...
data1 = np.loadtxt('../data/simple_car_path.txt')
data2 = np.loadtxt('../data/simple_car_path_app.txt')
data3 = np.loadtxt('../data/simple_car_path_geometric.txt')
data4 = np.loadtxt('../data/simple_car_path_geometric_app.txt')
